...
public class GameOverScreen implements Screen {
    ...
    private Inspiration _game;
    private static final String DEATH_MESSAGE = "你很英勇的战斗，但是，你还是失败了.";
    private static final String GAMEOVER = "GAME OVER";

    public GameOverScreen(Inspiration game){
        _game = game;

        //create
        _stage = new Stage();
    	// + Background
        Image imgBackground = new Image(new Texture(Gdx.files.internal("battle/gameover.png")));
...
//        TextButton continueButton = new TextButton("继续", Assets.instance.STATUSUI_SKIN);
//        TextButton mainMenuButton = new TextButton("返回主菜单", Assets.instance.STATUSUI_SKIN);
...
//        notify(AudioObserver.AudioCommand.MUSIC_PLAY_LOOP, AudioObserver.AudioTypeEvent.MUSIC_TITLE);
        Timer.schedule(new Timer.Task() {
            @Override
            public void run() {
                _game.mainGameScreen.resetGame();
